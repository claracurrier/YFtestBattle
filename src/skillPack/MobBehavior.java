...
public class MobBehavior {
    ...
    public abstract class mSkillCont extends AbstractControl {
        ...
        public mSkillCont(float length) {
            this.length = length;
        }
    ...
    public void pursue(final Node target, final Node mob, float time) {
        ...
        mob.addControl(new mSkillCont(time) {
            @Override
    ...
    public void wander(final Node mob, float length) {
        ...
        mob.addControl(new mSkillCont(length) {
    ...
    public void testDash(Node mob, EntityWrapper target, float length) {
    }
}