...
import playerPack.SkillCooldown.Cooldown;
...
public class PSkills {
    ...
    private AppSettings settings = BattleMain.settings;
    private Camera cam;
    private SkillGraphic graphic;
    private SkillCooldown skillCooldown;
    private SkillBehavior behavior;

    public PSkills(EntityWrapper d, EntityWrapper k, Camera c, SkillGraphic skillgraph,
